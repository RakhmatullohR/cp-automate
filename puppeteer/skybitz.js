...
const getWebsiteData = async (props) => {
  ...
  await page
    .type('input[name="strUserName"]', websiteEmail)
    .catch(async (err) => {
      result = {
        success: false,
        message:
  ...
  await page
    .type('input[name="strPassword"]', websitePassword)
    .catch(async (err) => {
      result = {
        success: false,
  ...
  await page.waitForSelector('#downloadData').catch(async (err) => {
    result = {
      success: false,
  ...
  await page.click('#downloadData').catch(async (err) => {
    result = {
      success: false,
      message:
  ...
  // Form Date
  var filename = __dirname + '/../download/websiteData/AssetsData.csv';
  // Form Date
  const formData = new FormData();
  formData.append('file', fs.createReadStream(filename));
  formData.append('trip-stage', 'skybitz');

  console.log('[skybitz] => sending request ...');
